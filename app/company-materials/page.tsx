...
import { Building, Search, Download, FileText, Users, Calendar } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Company Materials</h1>
            <p className="text-xl text-gray-600">Access company-specific interview materials and experiences</p>
          </div>
