...
import { Mail, Lock, User, ArrowRight, Github, Eye, EyeOff, Loader2, UserPlus } from "lucide-react"
        ...
        >
          <Card className="bg-gray-900/90 border-gray-700 backdrop-blur-md shadow-2xl">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl font-bold text-white">Join PlacementPro</CardTitle>
