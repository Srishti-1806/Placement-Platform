...
import { Mail, Lock, ArrowRight, Github, Eye, EyeOff, Loader2 } from "lucide-react"
        ...
        >
          <Card className="bg-gray-900/90 border-gray-700 backdrop-blur-md shadow-2xl">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-gray-400">Sign in to access your placement dashboard</CardDescription>
            </CardHeader>
