...
CORS(app, origins=[FRONTEND_URL, "http://16.171.134.238", "http://16.171.134.238:3000","http://16.171.134.238:8000", "ws://16.171.134.238:5000", "*", "http://localhost:8000"])
socketio = SocketIO(app, cors_allowed_origins=[FRONTEND_URL, "http://16.171.134.238", "http://16.171.134.238:3000", "ws://16.171.134.238:5000", "*", "http://16.171.134.238:8000", "http://localhost:8000"], async_mode='eventlet')
