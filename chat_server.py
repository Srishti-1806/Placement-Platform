...
CORS(app, origins=[FRONTEND_URL, "http://13.60.246.221", "http://13.60.246.221:3000", "http://13.60.246.221:5000","ws://13.60.246.221:5000", "*", "http://localhost:8000"])
socketio = SocketIO(app, cors_allowed_origins=[FRONTEND_URL, "http://13.60.246.221", "http://13.60.246.221:3000", "http://13.60.246.221:5000", "ws://13.60.246.221:5000", "*", "http://localhost:8000"], async_mode='eventlet')
