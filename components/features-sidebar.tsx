                  ...
                  >
                    <GalaxyHover>
                      <Link href={feature.href} onClick={() => setIsOpen(false)}>
                        <motion.div
                          className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-4 cursor-pointer group hover:border-purple-500/50 transition-all duration-300"
