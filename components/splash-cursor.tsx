...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      if (Math.random() < 0.3) {
        createParticle(mouseX + (Math.random() - 0.5) * 20, mouseY + (Math.random() - 0.5) * 20, 0.5)
      }
    ...
    function handleMouseMove(e: MouseEvent) {
      ...
      if (Math.random() < 0.5) {
        createParticle(mouseX, mouseY, 0.8)
      }
    }
    ...
    function handleMouseDown(e: MouseEvent) {
      ...
      for (let i = 0; i < 15; i++) {
        createParticle(mouseX, mouseY, 2)
      }
    }
  ...
  }, [DENSITY_DISSIPATION, VELOCITY_DISSIPATION, SPLAT_FORCE, COLOR_UPDATE_SPEED, BACK_COLOR])
